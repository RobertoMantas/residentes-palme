"""
Configuración de Django para el Sistema de Gestión de Residentes de Palme
"""
import os
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'residentes',  # Nuestra aplicación principal
]
...
WSGI_APPLICATION = 'residentes_palme.wsgi.application'
